...
class NewsletterCurrentIssue(Base):
    """Single-row table holding the most recent issue, sent to new subscribers.

    Updated automatically on every full live send, or explicitly via the
    /admin/newsletter/current endpoint.
    """
