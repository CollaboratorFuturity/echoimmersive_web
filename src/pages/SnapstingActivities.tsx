  ...
  return (
    <>
      ...
      <h1 className="text-3xl font-bold mb-4 border-b-2 border-gray-400 pb-2">
        Snapsting - Museum Wibergis — Activities
      </h1>
      ...
      <p className="italic text-gray-600 text-center max-w-3xl mx-auto my-12">
        ...
        The fact that the museum is the “final director”. We describe it as the exhibition manager (Rikke) stands at a mixing desk
        and the different channels she can mix on are set designers, painters, room-sound foley artist, AV experiences, objects, text, light, etc.)
      </p>
    </>
  )
}
