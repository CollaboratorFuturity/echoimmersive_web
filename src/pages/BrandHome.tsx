...
export default function BrandHome() {
  ...
  // Brand charcoal body background for this page, restore on unmount
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .brand-shine { position: relative; overflow: hidden; isolation: isolate; }
        .brand-shine::before {
          content: '';
          position: absolute;
          top: 0; left: -120%;
        ...
        .brand-shine:hover::before { left: 120%; }
        .brand-shine > * { position: relative; z-index: 2; }

        @media (prefers-reduced-motion: reduce) {
          .brand-fade-up     { animation: none; opacity: 1 !important; transform: none !important; }
          .brand-scroll-line { animation: none; opacity: 0.6; }
          .brand-shine::before { display: none; }
        }
      `}</style>

      {/* ── Dither background — warm lilac-purple on charcoal ───────── */}
      <div
        ref={ditherRef}
        style={{
          position: 'fixed',
      ...
      >
        ...
        >
          <span
            className="brand-fade-up border border-brand-lilac text-brand-lilac px-3 py-1 text-xs font-bold rounded tracking-widest uppercase mb-8"
          ...
          <h1
            className="brand-fade-up text-brand-cream font-extrabold mb-5 uppercase"
            style={{
          ...
          <p
            className="brand-fade-up max-w-md"
            style={{
          ...
          <div
            className="brand-fade-up absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2"
          ...
          >
            ...
            <div className="brand-scroll-line w-px h-8 bg-gradient-to-b from-brand-cream/40 to-transparent" />
          </div>
        </div>
      </div>
      ...
      >
        {stats.map(({ label }, i) => (
          <div key={label} className="bg-brand-charcoal/70 backdrop-blur-sm px-6 py-5 text-center">
            <div
              className="text-3xl font-extrabold mb-1 tabular-nums text-brand-lilac"
      ...
      <div className="mb-14">
        <p
          data-reveal
          className="text-xs font-bold uppercase tracking-widest text-brand-lilac mb-8"
          style={{
            fontFamily: 'Montserrat, sans-serif',
            opacity: 0,
            transform: 'translateY(20px)',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          >
            <div
              className="text-5xl mb-3 leading-none text-brand-lilac/30"
      ...
      >
        <span
          className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 text-xs uppercase tracking-widest text-brand-lilac"
      ...
      <div
        ...
        style={{
          ...
          transform: 'translateY(20px)',
          transition: 'opacity 800ms cubic-bezier(0.2,0.8,0.2,1), transform 800ms cubic-bezier(0.2,0.8,0.2,1)',
          backgroundColor: 'rgba(90, 66, 99, 0.35)',
      ...
      >
        ...
        <p
          className="font-bold text-lg text-brand-cream mb-7"
          style={{ fontFamily: 'Montserrat, sans-serif' }}
        >
        ...
        <button
          ...
          className="brand-shine px-10 py-3 bg-brand-lilac text-brand-charcoal rounded-lg font-bold text-xs uppercase tracking-widest
                     hover:shadow-[0_0_20px_#DA80FF,0_0_40px_rgba(218,128,255,0.25)] transition-shadow duration-300 cursor-pointer"
          style={{ fontFamily: 'Montserrat, sans-serif' }}
        >
