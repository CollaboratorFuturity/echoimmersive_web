...
const faqs = [
  { q: "What is Immersive ECHO?", a: "Immersive ECHO is a pan-European project bringing people closer to their shared heritage through immersive storytelling. Over 30 months (February 2026 – July 2028), 15 partners across 10 countries develop a practical model enabling cultural institutions to transform everyday public spaces into emotional, collective experiences — using projection, spatial audio, and sensor technology rather than VR headsets. The focus is on making immersive storytelling accessible to small and medium institutions that currently lack the budget and expertise to create it." },
  { q: "Why is this project needed?", a: "Most cultural heritage institutions lack the budget, expertise, and technical capacity to create immersive experiences. Large-scale productions are typically reserved for well-funded museums and commercial venues. At the same time, audiences increasingly expect engaging, multi-sensory encounters with culture. Immersive ECHO addresses this gap with a practical, transferable model — tested in real settings, documented honestly, and designed so a local museum with limited resources can tell its stories in ways that are emotionally engaging and economically sustainable." },
  { q: "What makes Immersive ECHO different from other immersive projects?", a: "Five things set us apart. We focus on small and medium institutions — not large-scale flagships. Our approach is headset-free: projection, spatial audio, and sensors transform existing public spaces. Inclusion is built into the design process, with dedicated sprints for youth, neurodivergent audiences, older adults, and marginalised groups. We document the entire process — including what doesn't work — and produce open toolkits so others can replicate the approach independently. And the consortium itself is unique: world-leading designers, researchers, heritage institutions of varying sizes, and technologists all working side by side." },
