...
const corePartners: Partner[] = [
  ...
  { file: 'NPIAT', name: 'New Practice in Art & Technology', url: 'https://www.newpractice.net/', large: true },
  { file: 'TPL', name: 'The Point Labs', url: 'https://thepointlabs.io/', large: true },
  ...
  { file: 'VIB_', name: 'Viborg Museum', url: 'https://viborgmuseum.dk/' },
  { file: 'TAW', name: 'The Animation Workshop', url: 'https://animationworkshop.via.dk/' },
