...
2. Edit the content. Rules for email HTML:
   ...
   - Absolute URLs for all links and images (`https://echoimmersive.futurity.science/...`).
...
To send from your machine against production, add `API_URL=https://echoimmersive.futurity.science`.
...
```sh
make newsletter-export API_URL=https://echoimmersive.futurity.science
```
